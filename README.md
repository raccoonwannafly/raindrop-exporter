...
Web application to export your specified Raindrop.io collections and bookmarks into various formats (JSON, HTML, CSV, XML), without having to wait for full on backup
